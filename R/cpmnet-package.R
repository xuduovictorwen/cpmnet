...
#' selection with five conceptual criteria: mean and median regression
#' loss, pinball quantile loss, the Brier score, and the held-out
#' log-likelihood; proper scoring rule criteria are also available.
